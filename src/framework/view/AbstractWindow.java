...
import framework.model.FincoObserver;
...
public abstract class AbstractWindow extends JFrame implements FincoObserver<IAccount> {
    ...
    protected void showMessage(Component c, String msgAlert, String titleAlert) {
        JOptionPane.showMessageDialog(c, msgAlert, titleAlert
