...
public class EntryDialog extends javax.swing.JDialog {
    ...
    private static final int DIALOUGE_WIDTH = 350;
    ...
    private static final int OK_BUTTON_X_OFFSET = 75;
    private static final int OK_BUTTON_WIDTH = 84;
    private static final int CANCEL_BUTTON_X_OFFSET = 165;
    private static final int CANCEL_BUTTON_WIDTH = 84;

    public EntryDialog(AbstractWindow parent, String title, String submitButtonLabel, String cancelButtonLabel,
        ...
        JButton_OK.setBounds(OK_BUTTON_X_OFFSET, entryYOffset, OK_BUTTON_WIDTH, ENTRY_HEIGHT);
        JButton_Cancel.setText(cancelButtonLabel);
        JButton_Cancel.setActionCommand(cancelButtonLabel);
        getContentPane().add(JButton_Cancel);
        JButton_Cancel.setBounds(CANCEL_BUTTON_X_OFFSET, entryYOffset, CANCEL_BUTTON_WIDTH, ENTRY_HEIGHT);
    ...
    public void JButtonCancel_actionPerformed(java.awt.event.ActionEvent event) {
        dispose();
    }
}